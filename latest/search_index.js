...

{
    ...
    "title": "Setup",
    "category": "section",
    "text": "All data will be read into equivalent DataFramesusing uCSV, CSV, TextParse, CodecZlib, Missings, DataFrames, Base.Test\nGDS = GzipDecompressorStream;\n\nfunction textparse2DF(x)\n    DataFrame(Any[x[1]...], Symbol.(x[2]))\nend"
},
